    ...
    <div className="upgrade-gate">
      ...
      <div className="upgrade-prompt">
        ...
        <div className="upgrade-prompt-footer">
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSeBTqx33UcwI5WWWpas9b_UifCaSMStQyQZNxtuEsvh-hPg7w/viewform" target="_blank" rel="noopener noreferrer nofollow" className="btn btn-primary upgrade-prompt-cta">
            Join Waitlist
          </a>
