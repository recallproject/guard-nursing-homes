  ...
  return (
    <section className="hero-section dlc-prov-2026q2" ref={heroRef}>
      ...
      <div className="hero-content">
        ...
        <p className="hero-tagline-secondary">Inspections, staffing, fines, and ownership for all 14,699 Medicare-certified facilities.</p>
        ...
        <div className="hero-stats" ref={statsRef}>
          ...
          <div className="hero-stat hero-stat--danger">
            ...
            <div className="hero-stat-label">Had days with zero registered nurse hours</div>
          </div>
          <div className="hero-stat">
            <div
              className="hero-stat-value"
