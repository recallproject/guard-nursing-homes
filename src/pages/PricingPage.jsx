...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      'An NP reviews the data and answers your questions',
  ...
  },
  {
    ...
    badge: 'DATA VERIFICATION IN PROGRESS',
    inherits: 'Everything in Free, plus:',
    features: [
      'All data cross-checked against live CMS sources',
      'Updated penalty and fine records',
      'Enhanced staffing benchmarks',
      'New clinical red flag indicators',
      'Ownership records verified',
      'Related-party transaction detail',
    ],
    cta: 'Audit in Progress — Returning Soon',
    ctaLink: '/evidence',
    ctaType: 'secondary',
  },
];
