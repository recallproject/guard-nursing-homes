    ...
    <div className="ac-page">
      ...
      <section className="ac-hero">
        ...
        <div className="ac-hero-badge">
          ...
          Prepared by a licensed Nurse Practitioner using public CMS data
        </div>
      </section>
      ...
      <div className="ac-main">
        ...
        <div className="ac-sidebar">
          ...
          <div className="ac-sidebar-card ac-clinician-card">
            ...
            <div className="ac-clinician-title">Nurse Practitioner · 20+ Years Clinical Experience</div>
            <p className="ac-clinician-bio">
              Robert has spent two decades at the bedside in acute and long-term care.
              Every report is prepared by him — not generated by AI, not written by an intern.
            </p>
          </div>
